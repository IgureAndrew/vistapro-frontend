...
// Emergency admin verification table creation
router.post('/emergency-create-admin-table', async (req, res) => {
  try {
    console.log('🚨 Emergency: Creating admin_verification_details table...');
    
    // Use the existing pool from the app

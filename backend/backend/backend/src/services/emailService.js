 ...
 * @param {string} token - Verification token (64-character hash)
 */
const sendVerificationEmail = async (email, firstName = 'User', token) => {
  console.log('🔑 DEBUG - emailService Parameters received:');
